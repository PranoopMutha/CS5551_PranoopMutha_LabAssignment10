...
public class MainActivity extends Activity
{
    ...
    public void searchText(View v) {
        ...
        String data = "https://kgsearch.googleapis.com/v1/entities:search?" + "query=" + searchString + "&" + "key= AIzaSyDNZm_zI6QWo3_omQeyK1zdc83aztjsyOI" + "&" + "indent=true" + "&" + "languages=en" + "&" + "limit=3";
